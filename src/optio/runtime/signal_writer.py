"""The single write path for every signal optio emits (M1-5).

Centralising emission here buys three things that matter more than the small
amount of indirection:

1. **Names come from** :mod:`optio.semconv` **only.** Downstream OPA, Cedar
...
from optio.errors import SignalWriteError
from optio.runtime.failopen import guarded
