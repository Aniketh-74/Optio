...
_ADAPTER_MODULES: Final[dict[str, tuple[str, str]]] = {
    "langgraph": ("optio.adapters.langgraph", "LangGraphAdapter"),
    "openai_agents": ("optio.adapters.openai_agents", "OpenAIAgentsAdapter"),
    "crewai": ("optio.adapters.crewai", "CrewAIAdapter"),
    "claude_agent": ("optio.adapters.claude_agent", "ClaudeAgentAdapter"),
}
